...
class Paper(models.Model):
    ...
    branch = models.CharField(max_length=5, choices=branch_choices, default='CSE', null=False)

    # for which semester paper is uploaded
    semester = models.IntegerField(choices=semester_choices, default=1, null=False)
